...
export function MarketDisplay() {
  ...
  return (
    <div className="card">
      <h3 className="text-xl font-bold mb-4">Market Odds</h3>
      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-2xl font-bold text-green-400" data-cy="yes-odds">
              {market.yesOdds}%
            </span>
          </div>
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-2xl font-bold text-red-400" data-cy="no-odds">
              {market.noOdds}%
            </span>
          </div>
          <div className="w-full bg-gray-700 rounded-full h-3">
        ...
        <div className="pt-4 border-t border-gray-700">
          ...
          <div className="flex justify-between text-sm mt-1">
            ...
            <span className="font-medium">{market.bets.length}</span>
          </div>
        </div>
      </div>
    </div>
